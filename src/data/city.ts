...
export const BUILDINGS: BuildingSpec[] = [
  ...
  { id: 'safehouse', name: 'Back Room', x: -21, z: 14, w: 14, d: 12, floors: 1, floorHeight: 3.2, color: '#a9d9d1', style: 'plain', facing: 'E', zone: 'downtown', interior: 'safehouse' },
...
/** Where each owned property's door / runner base is. */
export const PROPERTY_ANCHORS: Record<string, { x: number; z: number }> = {
  safehouse: { x: -13, z: 14 },
  warehouse: { x: -149, z: -60 },
  motel: { x: 151, z: -67 },
};

export const SPAWN = { x: -22, y: 0, z: 16, yaw: -0.51 };
export const SAFEHOUSE_DOOR = { x: -13, z: 14 };
/** Rico's old hatchback waits in the alley outside the back-room door, nose to the street. */
export const STARTER_CAR_SPOT = { x: -7.3, z: 12.5, yaw: Math.PI };
