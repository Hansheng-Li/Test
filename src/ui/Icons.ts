 ...
 */
const ICONS = new Set(['pulp_sunset', 'wax_velvet', 'gel_neon', 'mod_flux', 'mod_velvet_drops', 'mod_solar', 'mod_static', 'mod_sparks', 'mod_glow', 'baggies', 'eq_mixer', 'eq_sealer', 'eq_backpack', 'eq_brickphone', 'eq_scanner']);
