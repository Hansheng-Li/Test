  ...
  private render(): void {
    ...
    this.el.innerHTML = `
      ...
      <div class="howto" style="display:none;max-width:640px;font-size:13px;line-height:1.5;color:#ddd;background:rgba(0,0,0,0.4);padding:12px 16px;border-radius:6px;border:1px solid #444">
        ...
        <b style="color:#4ff2e8">HEAT</b> · Cops who see a deal raise it. Break line of sight, go home, or rest. Clean hands survive a stop-and-search; contraband does not. Sprint has stamina — you cannot outrun a chase forever. Dumpsters in the alleys are hiding spots (E) — but only once the cop has lost sight of you. Rojas resprays the sedan for $150: heat -30 and a chase called off.<br/>
