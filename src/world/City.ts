...
export function buildCity(): CityResult {
  ...
  const spraySign = new THREE.Mesh(new THREE.PlaneGeometry(2.2, 0.9), new THREE.MeshBasicMaterial({ map: signTexture(`RESPRAY $${RESPRAY_PRICE}`, { color: '#ffffff', bg: '#1565c0', glow: false, sub: 'NEW COAT · NO QUESTIONS' }), side: THREE.DoubleSide }));
